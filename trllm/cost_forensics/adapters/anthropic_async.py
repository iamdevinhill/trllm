"""Async auto-instrumentation adapter for the Anthropic Python SDK.
...
Usage::
    ...
    client = AsyncInstrumentedAnthropic(AsyncAnthropic())
...
class _AsyncInstrumentedMessages:
    """Wrapper around async client.messages that records events."""

    def __init__(
        self, messages: Any, owner: AsyncInstrumentedAnthropic
    ) -> None:
...
class AsyncInstrumentedAnthropic:
    """Drop-in wrapper around an AsyncAnthropic client that records a Computation.
    ...
    def __init__(self, client: Any) -> None:
        ...
        self.messages = _AsyncInstrumentedMessages(client.messages, self)
    ...
    def __repr__(self) -> str:
        ...
        return f"AsyncInstrumentedAnthropic(events={n})"
